...
{
    FGameplayTag GameplayCueTag;                                                      // 0x0010 (size: 0x8)
    FPredictionKey PredictionKey;                                                     // 0x0018 (size: 0x18)
    FGameplayCueParameters Parameters;                                                // 0x0030 (size: 0xB8)
...
{
    TArray<FActiveGameplayCue> GameplayCues;                                          // 0x00B0 (size: 0x10)
    class UAbilitySystemComponent* Owner;                                             // 0x00C8 (size: 0x8)
...
struct FActiveGameplayEffect : public FFastArraySerializerItem
{
    ...
    float StartServerWorldTime;                                                       // 0x02C8 (size: 0x4)
    float CachedStartServerWorldTime;                                                 // 0x02CC (size: 0x4)
    float StartWorldTime;                                                             // 0x02D0 (size: 0x4)
    bool bIsInhibited;                                                                // 0x02D4 (size: 0x1)
...
{
    TArray<FActiveGameplayEffect> GameplayEffects_Internal;                           // 0x0140 (size: 0x10)
    TArray<class UGameplayEffect*> ApplicationImmunityQueryEffects;                   // 0x04C0 (size: 0x10)
...
struct FAttributeBasedFloat
{
    ...
    FGameplayEffectAttributeCaptureDefinition BackingAttribute;                       // 0x0078 (size: 0x28)
...
struct FGameplayAbilityLocalAnimMontage
{
    ...
    class UGameplayAbility* AnimatingAbility;                                         // 0x0028 (size: 0x8)
...
struct FGameplayAbilityRepAnimMontage
{
    ...
    uint8 ServerInitiated;                                                            // 0x0015 (size: 0x1)
...
struct FGameplayAbilitySpec : public FFastArraySerializerItem
{
    ...
    FGameplayAbilityActivationInfo ActivationInfo;                                    // 0x0030 (size: 0x20)
    TArray<class UGameplayAbility*> NonReplicatedInstances;                           // 0x0050 (size: 0x10)
    TArray<class UGameplayAbility*> ReplicatedInstances;                              // 0x0060 (size: 0x10)
    FActiveGameplayEffectHandle GameplayEffectHandle;                                 // 0x0070 (size: 0x8)

}; // Size: 0xC8

struct FGameplayAbilitySpecContainer : public FFastArraySerializer
{
    TArray<FGameplayAbilitySpec> Items;                                               // 0x00B0 (size: 0x10)
...
struct FGameplayAbilitySpecDef
{
    ...
    FScalableFloat LevelScalableFloat;                                                // 0x0010 (size: 0x28)
    int32 InputID;                                                                    // 0x0038 (size: 0x4)
    EGameplayEffectGrantedAbilityRemovePolicy RemovalPolicy;                          // 0x003C (size: 0x1)
    class UObject* SourceObject;                                                      // 0x0040 (size: 0x8)
    FGameplayAbilitySpecHandle AssignedHandle;                                        // 0x0098 (size: 0x4)
...
struct FGameplayAttribute
{
    ...
    class UProperty* Attribute;                                                       // 0x0010 (size: 0x8)
    class UStruct* AttributeOwner;                                                    // 0x0018 (size: 0x8)
...
struct FGameplayCueObjectLibrary
{
    ...
    class UObjectLibrary* ActorObjectLibrary;                                         // 0x0090 (size: 0x8)
    class UObjectLibrary* StaticObjectLibrary;                                        // 0x0098 (size: 0x8)
    bool bShouldSyncScan;                                                             // 0x00A4 (size: 0x1)
    bool bShouldAsyncLoad;                                                            // 0x00A5 (size: 0x1)
    bool bShouldSyncLoad;                                                             // 0x00A6 (size: 0x1)
    class UGameplayCueSet* CueSet;                                                    // 0x00A8 (size: 0x8)
    bool bHasBeenInitialized;                                                         // 0x00B0 (size: 0x1)
...
struct FGameplayCuePendingExecute
{
    ...
    FGameplayCueParameters CueParameters;                                             // 0x00B8 (size: 0xB8)
...
struct FGameplayCueTranslatorNode
{
    ...
    FGameplayTag CachedGameplayTag;                                                   // 0x0018 (size: 0x8)
    FName CachedGameplayTagName;                                                      // 0x0020 (size: 0x8)
...
{
    FGameplayAttribute AttributeToCapture;                                            // 0x0000 (size: 0x20)
    EGameplayEffectAttributeCaptureSource AttributeSource;                            // 0x0020 (size: 0x1)
    bool bSnapshot;                                                                   // 0x0021 (size: 0x1)

}; // Size: 0x28

struct FGameplayEffectAttributeCaptureSpec
{
    FGameplayEffectAttributeCaptureDefinition BackingDefinition;                      // 0x0000 (size: 0x28)
...
{
    FGameplayAttribute MagnitudeAttribute;                                            // 0x0000 (size: 0x20)
    float MinLevel;                                                                   // 0x0020 (size: 0x4)
    float MaxLevel;                                                                   // 0x0024 (size: 0x4)
    FGameplayTagContainer GameplayCueTags;                                            // 0x0028 (size: 0x20)
...
{
    FGameplayEffectAttributeCaptureDefinition CapturedAttribute;                      // 0x0000 (size: 0x28)
    TEnumAsByte<EGameplayModOp::Type> ModifierOp;                                     // 0x0028 (size: 0x1)
    FGameplayEffectModifierMagnitude ModifierMagnitude;                               // 0x0030 (size: 0x1C8)
...
struct FGameplayEffectModifiedAttribute
{
    ...
    float TotalMagnitude;                                                             // 0x0020 (size: 0x4)
...
struct FGameplayEffectModifierMagnitude
{
    ...
    FAttributeBasedFloat AttributeBasedMagnitude;                                     // 0x0030 (size: 0xF8)
    FCustomCalculationBasedFloat CustomMagnitude;                                     // 0x0128 (size: 0x90)
    FSetByCallerFloat SetByCallerMagnitude;                                           // 0x01B8 (size: 0x10)

}; // Size: 0x1C8

struct FGameplayEffectQuery
{
    FGameplayEffectQueryCustomMatchDelegate_BP CustomMatchDelegate_BP;                // 0x0040 (size: 0x10)
    void ActiveGameplayEffectQueryCustomMatch_Dynamic(FActiveGameplayEffect Effect, bool& bMatches);
    FGameplayTagQuery OwningTagQuery;                                                 // 0x0050 (size: 0x48)
    FGameplayTagQuery EffectTagQuery;                                                 // 0x0098 (size: 0x48)
    FGameplayTagQuery SourceTagQuery;                                                 // 0x00E0 (size: 0x48)
    FGameplayAttribute ModifyingAttribute;                                            // 0x0128 (size: 0x20)
    class UObject* EffectSource;                                                      // 0x0148 (size: 0x8)
    TSubclassOf<class UGameplayEffect> EffectDefinition;                              // 0x0150 (size: 0x8)
...
struct FGameplayEventData
{
    ...
    FGameplayAbilityTargetDataHandle TargetData;                                      // 0x0088 (size: 0x20)
...
{
    FGameplayAttribute Attribute;                                                     // 0x0000 (size: 0x20)
    TEnumAsByte<EGameplayModOp::Type> ModifierOp;                                     // 0x0020 (size: 0x1)
    float Magnitude;                                                                  // 0x0024 (size: 0x4)
    FActiveGameplayEffectHandle Handle;                                               // 0x0028 (size: 0x8)
...
struct FGameplayModifierInfo
{
    FGameplayAttribute Attribute;                                                     // 0x0000 (size: 0x20)
    TEnumAsByte<EGameplayModOp::Type> ModifierOp;                                     // 0x0020 (size: 0x1)
    FScalableFloat Magnitude;                                                         // 0x0028 (size: 0x28)
    FGameplayEffectModifierMagnitude ModifierMagnitude;                               // 0x0050 (size: 0x1C8)
    FGameplayModEvaluationChannelSettings EvaluationChannelSettings;                  // 0x0218 (size: 0x1)
    FGameplayTagRequirements SourceTags;                                              // 0x0220 (size: 0x40)
    FGameplayTagRequirements TargetTags;                                              // 0x0260 (size: 0x40)
...
struct FGameplayTargetDataFilter
{
    ...
    TEnumAsByte<ETargetDataFilterSelf::Type> SelfFilter;                              // 0x0010 (size: 0x1)
    TSubclassOf<class AActor> RequiredActorClass;                                     // 0x0018 (size: 0x8)
    bool bReverseFilter;                                                              // 0x0020 (size: 0x1)
...
struct FPredictionKey
{
    ...
    class UPackageMap* PredictiveConnection;                                          // 0x0008 (size: 0x8)
    bool bIsStale;                                                                    // 0x0010 (size: 0x1)
    bool bIsServerInitiated;                                                          // 0x0011 (size: 0x1)
...
{
    TArray<FReplicatedPredictionKeyItem> PredictionKeys;                              // 0x00B0 (size: 0x10)
...
struct FServerAbilityRPCBatch
{
    ...
    FGameplayAbilityTargetDataHandle TargetData;                                      // 0x0020 (size: 0x20)
...
{
    class UAbilitySystemComponent* AbilitySystemComponent;                            // 0x03B8 (size: 0x8)

}; // Size: 0x3C0

class AGameplayAbilityTargetActor : public AActor
{
    bool ShouldProduceTargetDataOnServer;                                             // 0x0318 (size: 0x1)
    FGameplayAbilityTargetingLocationInfo StartLocation;                              // 0x0320 (size: 0x70)
    class APlayerController* MasterPC;                                                // 0x0470 (size: 0x8)
    class UGameplayAbility* OwningAbility;                                            // 0x0478 (size: 0x8)
    bool bDestroyOnConfirmation;                                                      // 0x0480 (size: 0x1)
    class AActor* SourceActor;                                                        // 0x0488 (size: 0x8)
    FWorldReticleParameters ReticleParams;                                            // 0x0490 (size: 0xC)
    TSubclassOf<class AGameplayAbilityWorldReticle> ReticleClass;                     // 0x04A0 (size: 0x8)
    FGameplayTargetDataFilterHandle Filter;                                           // 0x04A8 (size: 0x10)
    bool bDebug;                                                                      // 0x04B8 (size: 0x1)
    class UAbilitySystemComponent* GenericDelegateBoundASC;                           // 0x04D0 (size: 0x8)
...
{
    UClass* PlacedActorClass;                                                         // 0x0518 (size: 0x8)
    class UMaterialInterface* PlacedActorMaterial;                                    // 0x0520 (size: 0x8)

}; // Size: 0x530

class AGameplayAbilityTargetActor_GroundTrace : public AGameplayAbilityTargetActor_Trace
{
    float CollisionRadius;                                                            // 0x04F8 (size: 0x4)
    float CollisionHeight;                                                            // 0x04FC (size: 0x4)
...
{
    float MaxRange;                                                                   // 0x04D8 (size: 0x4)
    FCollisionProfileName TraceProfile;                                               // 0x04E0 (size: 0x8)
    bool bTraceAffectsAimPitch;                                                       // 0x04E8 (size: 0x1)

}; // Size: 0x500

class AGameplayAbilityWorldReticle : public AActor
{
    FWorldReticleParameters Parameters;                                               // 0x0318 (size: 0xC)
    bool bFaceOwnerFlat;                                                              // 0x0324 (size: 0x1)
    bool bSnapToTargetedActor;                                                        // 0x0325 (size: 0x1)
    bool bIsTargetValid;                                                              // 0x0326 (size: 0x1)
    bool bIsTargetAnActor;                                                            // 0x0327 (size: 0x1)
    class APlayerController* MasterPC;                                                // 0x0328 (size: 0x8)
    class AActor* TargetingActor;                                                     // 0x0330 (size: 0x8)
...
{
    class UCapsuleComponent* CollisionComponent;                                      // 0x0338 (size: 0x8)
    TArray<class UActorComponent*> VisualizationComponents;                           // 0x0340 (size: 0x10)

}; // Size: 0x350

class AGameplayCueNotify_Actor : public AActor
{
    bool bAutoDestroyOnRemove;                                                        // 0x0318 (size: 0x1)
    float AutoDestroyDelay;                                                           // 0x031C (size: 0x4)
    bool WarnIfTimelineIsStillRunning;                                                // 0x0320 (size: 0x1)
    bool WarnIfLatentActionIsStillRunning;                                            // 0x0321 (size: 0x1)
    FGameplayTag GameplayCueTag;                                                      // 0x0328 (size: 0x8)
    FGameplayTagReferenceHelper ReferenceHelper;                                      // 0x0330 (size: 0x40)
    FName GameplayCueName;                                                            // 0x0370 (size: 0x8)
    bool bAutoAttachToOwner;                                                          // 0x0378 (size: 0x1)
    bool IsOverride;                                                                  // 0x0379 (size: 0x1)
    bool bUniqueInstancePerInstigator;                                                // 0x037A (size: 0x1)
    bool bUniqueInstancePerSourceObject;                                              // 0x037B (size: 0x1)
    bool bAllowMultipleOnActiveEvents;                                                // 0x037C (size: 0x1)
    bool bAllowMultipleWhileActiveEvents;                                             // 0x037D (size: 0x1)
    int32 NumPreallocatedInstances;                                                   // 0x0380 (size: 0x4)
...
{
    TArray<FAttributeDefaults> DefaultStartingData;                                   // 0x0180 (size: 0x10)
    TArray<class UAttributeSet*> SpawnedAttributes;                                   // 0x0190 (size: 0x10)
    float OutgoingDuration;                                                           // 0x0420 (size: 0x4)
    float IncomingDuration;                                                           // 0x0424 (size: 0x4)
    TArray<FString> ClientDebugStrings;                                               // 0x0450 (size: 0x10)
    TArray<FString> ServerDebugStrings;                                               // 0x0460 (size: 0x10)
    FGameplayAbilitySpecContainer ActivatableAbilities;                               // 0x0470 (size: 0xC8)
    TArray<class UGameplayAbility*> AllReplicatedInstancedAbilities;                  // 0x0588 (size: 0x10)
    TArray<class AGameplayAbilityTargetActor*> SpawnedTargetActors;                   // 0x0AE0 (size: 0x10)
    FGameplayAbilityRepAnimMontage RepAnimMontageInfo;                                // 0x0AF0 (size: 0x30)
    FGameplayAbilityLocalAnimMontage LocalAnimMontageInfo;                            // 0x0B28 (size: 0x30)
    class AActor* OwnerActor;                                                         // 0x0C70 (size: 0x8)
    class AActor* AvatarActor;                                                        // 0x0C78 (size: 0x8)
    FActiveGameplayEffectsContainer ActiveGameplayEffects;                            // 0x0CA0 (size: 0x4F0)
    FActiveGameplayCueContainer ActiveGameplayCues;                                   // 0x1190 (size: 0xD0)
    FActiveGameplayCueContainer MinimalReplicationGameplayCues;                       // 0x1260 (size: 0xD0)
    TArray<uint8> BlockedAbilityBindings;                                             // 0x14B0 (size: 0x10)
    FMinimalReplicationTagCountMap MinimalReplicationTags;                            // 0x1640 (size: 0x60)
    FReplicatedPredictionKeyMap ReplicatedPredictionKeyMap;                           // 0x16B0 (size: 0xC0)
    ...
    FActiveGameplayEffectHandle BP_ApplyGameplayEffectSpecToTarget(FGameplayEffectSpecHandle& SpecHandle, class UAbilitySystemComponent* Target);
...
class UAbilitySystemGlobals : public UObject
{
    ...
    FGameplayTag ActivateFailIsDeadTag;                                               // 0x00C0 (size: 0x8)
    FName ActivateFailIsDeadName;                                                     // 0x00C8 (size: 0x8)
    FGameplayTag ActivateFailCooldownTag;                                             // 0x00D0 (size: 0x8)
    FName ActivateFailCooldownName;                                                   // 0x00D8 (size: 0x8)
    FGameplayTag ActivateFailCostTag;                                                 // 0x00E0 (size: 0x8)
    FName ActivateFailCostName;                                                       // 0x00E8 (size: 0x8)
    FGameplayTag ActivateFailTagsBlockedTag;                                          // 0x00F0 (size: 0x8)
    FName ActivateFailTagsBlockedName;                                                // 0x00F8 (size: 0x8)
    FGameplayTag ActivateFailTagsMissingTag;                                          // 0x0100 (size: 0x8)
    FName ActivateFailTagsMissingName;                                                // 0x0108 (size: 0x8)
    FGameplayTag ActivateFailNetworkingTag;                                           // 0x0110 (size: 0x8)
    FName ActivateFailNetworkingName;                                                 // 0x0118 (size: 0x8)
    int32 MinimalReplicationTagCountBits;                                             // 0x0120 (size: 0x4)
    bool bAllowGameplayModEvaluationChannels;                                         // 0x0124 (size: 0x1)
    EGameplayModEvaluationChannel DefaultGameplayModEvaluationChannel;                // 0x0125 (size: 0x1)
    FName GameplayModEvaluationChannelAliases;                                        // 0x0128 (size: 0x50)
    FSoftObjectPath GlobalCurveTableName;                                             // 0x0178 (size: 0x18)
    FSoftObjectPath GlobalAttributeMetaDataTableName;                                 // 0x0190 (size: 0x18)
    FSoftObjectPath GlobalAttributeSetDefaultsTableName;                              // 0x01A8 (size: 0x18)
    TArray<FSoftObjectPath> GlobalAttributeSetDefaultsTableNames;                     // 0x01C0 (size: 0x10)
    FSoftObjectPath GlobalGameplayCueManagerClass;                                    // 0x01D0 (size: 0x18)
    FSoftObjectPath GlobalGameplayCueManagerName;                                     // 0x01E8 (size: 0x18)
    TArray<FString> GameplayCueNotifyPaths;                                           // 0x0200 (size: 0x10)
    FSoftObjectPath GameplayTagResponseTableName;                                     // 0x0210 (size: 0x18)
    class UGameplayTagReponseTable* GameplayTagResponseTable;                         // 0x0228 (size: 0x8)
    bool PredictTargetGameplayEffects;                                                // 0x0230 (size: 0x1)
    class UCurveTable* GlobalCurveTable;                                              // 0x0238 (size: 0x8)
    TArray<class UCurveTable*> GlobalAttributeDefaultsTables;                         // 0x0240 (size: 0x10)
    class UDataTable* GlobalAttributeMetaDataTable;                                   // 0x0250 (size: 0x8)
    class UGameplayCueManager* GlobalGameplayCueManager;                              // 0x0258 (size: 0x8)
...
class UAbilityTask_ApplyRootMotionConstantForce : public UAbilityTask_ApplyRootMotion_Base
{
    ...
    class UAbilityTask_ApplyRootMotionConstantForce* ApplyRootMotionConstantForce(class UGameplayAbility* OwningAbility, FName TaskInstanceName, FVector WorldDirection, float Strength, float Duration, bool bIsAdditive, class UCurveFloat* StrengthOverTime, ERootMotionFinishVelocityMode VelocityOnFinishMode, FVector SetVelocityOnFinish, float ClampVelocityOnFinish);
}; // Size: 0xE8
...
class UAbilityTask_WaitAttributeChange : public UAbilityTask
{
    ...
    class UAbilitySystemComponent* ExternalOwner;                                     // 0x00D8 (size: 0x8)
...
class UAbilityTask_WaitAttributeChangeRatioThreshold : public UAbilityTask
{
    ...
    class UAbilitySystemComponent* ExternalOwner;                                     // 0x0108 (size: 0x8)
...
class UAbilityTask_WaitAttributeChangeThreshold : public UAbilityTask
{
    ...
    class UAbilitySystemComponent* ExternalOwner;                                     // 0x00D0 (size: 0x8)
...
class UAbilityTask_WaitGameplayEvent : public UAbilityTask
{
    ...
    class UAbilityTask_WaitGameplayEvent* WaitGameplayEvent(class UGameplayAbility* OwningAbility, FGameplayTag EventTag, class AActor* OptionalExternalTarget, bool OnlyTriggerOnce);
}; // Size: 0xB0
...
{
    FGameplayTagContainer AbilityTags;                                                // 0x01F0 (size: 0x20)
    bool bReplicateInputDirectly;                                                     // 0x0280 (size: 0x1)
    TEnumAsByte<EGameplayAbilityReplicationPolicy::Type> ReplicationPolicy;           // 0x02A9 (size: 0x1)
    TEnumAsByte<EGameplayAbilityInstancingPolicy::Type> InstancingPolicy;             // 0x02AA (size: 0x1)
    bool bServerRespectsRemoteAbilityCancellation;                                    // 0x02AB (size: 0x1)
    bool bRetriggerInstancedAbility;                                                  // 0x02AC (size: 0x1)
    FGameplayAbilityActivationInfo CurrentActivationInfo;                             // 0x02B0 (size: 0x20)
    FGameplayEventData CurrentEventData;                                              // 0x02D0 (size: 0xA8)
    TEnumAsByte<EGameplayAbilityNetExecutionPolicy::Type> NetExecutionPolicy;         // 0x0378 (size: 0x1)
    TSubclassOf<class UGameplayEffect> CostGameplayEffectClass;                       // 0x0380 (size: 0x8)
    TArray<FAbilityTriggerData> AbilityTriggers;                                      // 0x0388 (size: 0x10)
    TSubclassOf<class UGameplayEffect> CooldownGameplayEffectClass;                   // 0x0398 (size: 0x8)
    FGameplayTagQuery CancelAbilitiesMatchingTagQuery;                                // 0x03A0 (size: 0x48)
    FGameplayTagQuery ConstTagQuery;                                                  // 0x03E8 (size: 0x48)
    FGameplayTagContainer CancelAbilitiesWithTag;                                     // 0x0430 (size: 0x20)
    FGameplayTagContainer BlockAbilitiesWithTag;                                      // 0x0450 (size: 0x20)
    FGameplayTagContainer ActivationOwnedTags;                                        // 0x0470 (size: 0x20)
    FGameplayTagContainer ActivationRequiredTags;                                     // 0x0490 (size: 0x20)
    FGameplayTagContainer ActivationBlockedTags;                                      // 0x04B0 (size: 0x20)
    FGameplayTagContainer SourceRequiredTags;                                         // 0x04D0 (size: 0x20)
    FGameplayTagContainer SourceBlockedTags;                                          // 0x04F0 (size: 0x20)
    FGameplayTagContainer TargetRequiredTags;                                         // 0x0510 (size: 0x20)
    FGameplayTagContainer TargetBlockedTags;                                          // 0x0530 (size: 0x20)
    TArray<class UGameplayTask*> ActiveTasks;                                         // 0x0550 (size: 0x10)
    class UAnimMontage* CurrentMontage;                                               // 0x05D0 (size: 0x8)
    bool bIsActive;                                                                   // 0x05D8 (size: 0x1)
    bool bIsCancelable;                                                               // 0x05D9 (size: 0x1)
    bool bIsBlockingOtherAbilities;                                                   // 0x05F0 (size: 0x1)
...
{
    class UAnimMontage* MontageToPlay;                                                // 0x05F8 (size: 0x8)
    float PlayRate;                                                                   // 0x0600 (size: 0x4)
    FName SectionName;                                                                // 0x0608 (size: 0x8)
    TArray<class TSubclassOf<UGameplayEffect>> GameplayEffectClassesWhileAnimating;   // 0x0610 (size: 0x10)
    TArray<class UGameplayEffect*> GameplayEffectsWhileAnimating;                     // 0x0620 (size: 0x10)

}; // Size: 0x630

class UGameplayCueManager : public UDataAsset
{
    FGameplayCueObjectLibrary RuntimeGameplayCueObjectLibrary;                        // 0x00A0 (size: 0xC0)
    FGameplayCueObjectLibrary EditorGameplayCueObjectLibrary;                         // 0x0160 (size: 0xC0)
    TArray<class UClass*> LoadedGameplayCueNotifyClasses;                             // 0x03D0 (size: 0x10)
    TArray<class TSubclassOf<AGameplayCueNotify_Actor>> GameplayCueClassesForPreallocation; // 0x03E0 (size: 0x10)
    TArray<FGameplayCuePendingExecute> PendingExecuteCues;                            // 0x03F0 (size: 0x10)
    int32 GameplayCueSendContextCount;                                                // 0x0400 (size: 0x4)
    TArray<FPreallocationInfo> PreallocationInfoList_Internal;                        // 0x0408 (size: 0x10)

}; // Size: 0x490

class UGameplayCueNotify_HitImpact : public UGameplayCueNotify_Static
{
    class USoundBase* Sound;                                                          // 0x0080 (size: 0x8)
    class UParticleSystem* ParticleSystem;                                            // 0x0088 (size: 0x8)
...
class UGameplayCueNotify_Static : public UObject
{
    ...
    FGameplayTagReferenceHelper ReferenceHelper;                                      // 0x0030 (size: 0x40)
    FName GameplayCueName;                                                            // 0x0070 (size: 0x8)
    bool IsOverride;                                                                  // 0x0078 (size: 0x1)
...
class UGameplayEffect : public UObject
{
    ...
    FGameplayEffectModifierMagnitude DurationMagnitude;                               // 0x0038 (size: 0x1C8)
    FScalableFloat Period;                                                            // 0x0200 (size: 0x28)
    bool bExecutePeriodicEffectOnApplication;                                         // 0x0228 (size: 0x1)
    TArray<FGameplayModifierInfo> Modifiers;                                          // 0x0230 (size: 0x10)
    TArray<FGameplayEffectExecutionDefinition> Executions;                            // 0x0240 (size: 0x10)
    FScalableFloat ChanceToApplyToTarget;                                             // 0x0250 (size: 0x28)
    TArray<class TSubclassOf<UGameplayEffectCustomApplicationRequirement>> ApplicationRequirements; // 0x0278 (size: 0x10)
    TArray<class TSubclassOf<UGameplayEffect>> TargetEffectClasses;                   // 0x0288 (size: 0x10)
    TArray<FConditionalGameplayEffect> ConditionalGameplayEffects;                    // 0x0298 (size: 0x10)
    TArray<class TSubclassOf<UGameplayEffect>> OverflowEffects;                       // 0x02A8 (size: 0x10)
    bool bDenyOverflowApplication;                                                    // 0x02B8 (size: 0x1)
    bool bClearStackOnOverflow;                                                       // 0x02B9 (size: 0x1)
    TArray<class TSubclassOf<UGameplayEffect>> PrematureExpirationEffectClasses;      // 0x02C0 (size: 0x10)
    TArray<class TSubclassOf<UGameplayEffect>> RoutineExpirationEffectClasses;        // 0x02D0 (size: 0x10)
    bool bRequireModifierSuccessToTriggerCues;                                        // 0x02E0 (size: 0x1)
    bool bSuppressStackingCues;                                                       // 0x02E1 (size: 0x1)
    TArray<FGameplayEffectCue> GameplayCues;                                          // 0x02E8 (size: 0x10)
    class UGameplayEffectUIData* UIData;                                              // 0x02F8 (size: 0x8)
    FInheritedTagContainer InheritableGameplayEffectTags;                             // 0x0300 (size: 0x60)
    FInheritedTagContainer InheritableOwnedTagsContainer;                             // 0x0360 (size: 0x60)
    FGameplayTagRequirements OngoingTagRequirements;                                  // 0x03C0 (size: 0x40)
    FGameplayTagRequirements ApplicationTagRequirements;                              // 0x0400 (size: 0x40)
    FInheritedTagContainer RemoveGameplayEffectsWithTags;                             // 0x0440 (size: 0x60)
    FGameplayTagRequirements GrantedApplicationImmunityTags;                          // 0x04A0 (size: 0x40)
    FGameplayEffectQuery GrantedApplicationImmunityQuery;                             // 0x04E0 (size: 0x170)
    EGameplayEffectStackingType StackingType;                                         // 0x0651 (size: 0x1)
    int32 StackLimitCount;                                                            // 0x0654 (size: 0x4)
    EGameplayEffectStackingDurationPolicy StackDurationRefreshPolicy;                 // 0x0658 (size: 0x1)
    EGameplayEffectStackingPeriodPolicy StackPeriodResetPolicy;                       // 0x0659 (size: 0x1)
    EGameplayEffectStackingExpirationPolicy StackExpirationPolicy;                    // 0x065A (size: 0x1)
    TArray<FGameplayAbilitySpecDef> GrantedAbilities;                                 // 0x0660 (size: 0x10)
