#ifndef UE4SS_SDK_SaveFairy_HPP
#define UE4SS_SDK_SaveFairy_HPP

class ASaveFairy_C : public ABP_Base_NPC_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0858 (size: 0x8)
    class UFalconEnemyStateComponent* State_Charged;                                  // 0x0860 (size: 0x8)
    class UFalconEnemyStateComponent* State_AppearPostDragonReplay;                   // 0x0868 (size: 0x8)
    class UFalconEnemyStateComponent* State_Talk;                                     // 0x0870 (size: 0x8)
    class UFalconEnemyStateComponent* State_DelayZap;                                 // 0x0878 (size: 0x8)
    class UFalconEnemyStateComponent* State_AppearZap;                                // 0x0880 (size: 0x8)
    class UFalconEnemyStateComponent* State_HiddenRespawn;                            // 0x0888 (size: 0x8)
    class UFalconEnemyStateComponent* State_ResetRadius;                              // 0x0890 (size: 0x8)
    class UFalconEnemyStateComponent* State_ZapCheck;                                 // 0x0898 (size: 0x8)
    class UCameraComponent* Camera;                                                   // 0x08A0 (size: 0x8)
    class UPointLightComponent* PointLight;                                           // 0x08A8 (size: 0x8)
    class UPointLightComponent* PointLight_wand;                                      // 0x08B0 (size: 0x8)
    class UParticleSystemComponent* FairyGlow;                                        // 0x08B8 (size: 0x8)
    class UParticleSystemComponent* WandSparkles;                                     // 0x08C0 (size: 0x8)
    class UFalconEnemyStateComponent* State_HiddenIGC;                                // 0x08C8 (size: 0x8)
    class UFalconEnemyStateComponent* State_DisappearIGC;                             // 0x08D0 (size: 0x8)
    class USceneComponent* Wand_End;                                                  // 0x08D8 (size: 0x8)
    class UStaticMeshComponent* Wand;                                                 // 0x08E0 (size: 0x8)
    class UFalconEnemyStateComponent* State_NPC;                                      // 0x08E8 (size: 0x8)
    class UFalconEnemyComponent* FalconEnemy;                                         // 0x08F0 (size: 0x8)
    class UFalconEnemyStateComponent* State_ZapDone;                                  // 0x08F8 (size: 0x8)
    class UFalconEnemyStateComponent* State_Disappear;                                // 0x0900 (size: 0x8)
    class UFalconEnemyStateComponent* State_TurnTo;                                   // 0x0908 (size: 0x8)
    class UFalconEnemyStateComponent* State_Wait;                                     // 0x0910 (size: 0x8)
    class UFalconEnemyStateComponent* State_PromptVisible;                            // 0x0918 (size: 0x8)
    class UFalconEnemyStateComponent* State_Zap;                                      // 0x0920 (size: 0x8)
    class UFalconEnemyStateComponent* State_Alert;                                    // 0x0928 (size: 0x8)
    class UFalconEnemyStateComponent* State_Appear;                                   // 0x0930 (size: 0x8)
    class UFalconEnemyStateComponent* State_Hidden;                                   // 0x0938 (size: 0x8)
    class UFalconEnemyStateComponent* State_Inactive;                                 // 0x0940 (size: 0x8)
    float Timeline_0_NewTrack_0_B403322348F814C8C4EC0B9067ACAEDE;                     // 0x0948 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_0__Direction_B403322348F814C8C4EC0B9067ACAEDE; // 0x094C (size: 0x1)
    class UTimelineComponent* Timeline_0;                                             // 0x0950 (size: 0x8)
    float ZapDelay_NewTrack_0_AC02C24F44B6AB127A0ACCB3ECE10090;                       // 0x0958 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ZapDelay__Direction_AC02C24F44B6AB127A0ACCB3ECE10090; // 0x095C (size: 0x1)
    class UTimelineComponent* ZapDelay;                                               // 0x0960 (size: 0x8)
    class ACollectable_Dragon_C* WatchActor;                                          // 0x0968 (size: 0x8)
    bool SaveState;                                                                   // 0x0970 (size: 0x1)
    bool NPC_Start;                                                                   // 0x0971 (size: 0x1)
    bool VFX_Trigger;                                                                 // 0x0972 (size: 0x1)
    class ASaveFairy_CheckPoint_C* Checkpoint;                                        // 0x0978 (size: 0x8)
    FString LevelCheckpointRef;                                                       // 0x0980 (size: 0x10)
    FString CheckPointName;                                                           // 0x0990 (size: 0x10)
    bool IGCVersion;                                                                  // 0x09A0 (size: 0x1)
    bool SavedCheckpoint;                                                             // 0x09A1 (size: 0x1)
    bool ZapImmediately;                                                              // 0x09A2 (size: 0x1)
    FText FairyName;                                                                  // 0x09A8 (size: 0x18)
    class AActor* LastFairySave;                                                      // 0x09C0 (size: 0x8)
    bool PlayerRespawned;                                                             // 0x09C8 (size: 0x1)
    class UParticleSystem* VFX_UniqueFairyFX;                                         // 0x09D0 (size: 0x8)
    bool BindToPlayerDeath;                                                           // 0x09D8 (size: 0x1)
    FName StateOverride;                                                              // 0x09E0 (size: 0x8)
    class UParticleSystem* customSaveFairyVFX;                                        // 0x09E8 (size: 0x8)
    float RelativeZPos;                                                               // 0x09F0 (size: 0x4)
    ...
    void BndEvt__State_Charged_K2Node_ComponentBoundEvent_0_StateChangeSignature__DelegateSignature(class UFalconEnemyStateComponent* StateComponent);
    void ExecuteUbergraph_SaveFairy(int32 EntryPoint);
}; // Size: 0x9F4
