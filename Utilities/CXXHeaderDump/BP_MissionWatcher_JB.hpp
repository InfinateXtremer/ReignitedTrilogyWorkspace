#ifndef UE4SS_SDK_BP_MissionWatcher_JB_HPP
#define UE4SS_SDK_BP_MissionWatcher_JB_HPP

class ABP_MissionWatcher_JB_C : public AActor
{
    ...
    void ExecuteUbergraph_BP_MissionWatcher_JB(int32 EntryPoint);
}; // Size: 0x340
