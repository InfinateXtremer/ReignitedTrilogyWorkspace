...
{
    class UDestructibleComponent* DestructibleComponent;                              // 0x0318 (size: 0x8)
    uint8 bAffectNavigation;                                                          // 0x0320 (size: 0x1)
    FDestructibleActorOnActorFracture OnActorFracture;                                // 0x0328 (size: 0x10)

}; // Size: 0x338

class UDestructibleComponent : public USkinnedMeshComponent
{
    uint8 bFractureEffectOverride;                                                    // 0x0810 (size: 0x1)
    TArray<FFractureEffect> FractureEffects;                                          // 0x0818 (size: 0x10)
    bool bEnableHardSleeping;                                                         // 0x0828 (size: 0x1)
    float LargeChunkThreshold;                                                        // 0x082C (size: 0x4)
    FDestructibleComponentOnComponentFracture OnComponentFracture;                    // 0x0840 (size: 0x10)
...
{
    FDestructibleParameters DefaultDestructibleParameters;                            // 0x0300 (size: 0x88)
    TArray<FFractureEffect> FractureEffects;                                          // 0x0388 (size: 0x10)
