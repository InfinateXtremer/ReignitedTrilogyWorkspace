#ifndef UE4SS_SDK_UI_HUD_Colon_HPP
#define UE4SS_SDK_UI_HUD_Colon_HPP

class UUI_HUD_Colon_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_UI_HUD_Colon(int32 EntryPoint);
}; // Size: 0x260
