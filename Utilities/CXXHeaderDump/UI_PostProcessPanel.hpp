#ifndef UE4SS_SDK_UI_PostProcessPanel_HPP
#define UE4SS_SDK_UI_PostProcessPanel_HPP

class UUI_PostProcessPanel_C : public UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0208 (size: 0x8)
    class UUI_Cine_TextBlock_C* CineTextBlock_0;                                      // 0x0210 (size: 0x8)
    class UExpandableArea* EFogArea;                                                  // 0x0218 (size: 0x8)
    class UScrollBox* PostProcessList;                                                // 0x0220 (size: 0x8)
    ...
    void ExecuteUbergraph_UI_PostProcessPanel(int32 EntryPoint);
}; // Size: 0x230
