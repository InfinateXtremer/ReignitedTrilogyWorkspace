#ifndef UE4SS_SDK_BP_HudTimerComponent_HPP
#define UE4SS_SDK_BP_HudTimerComponent_HPP

class UBP_HudTimerComponent_C : public UHudTimerComponent
{
    ...
    void HideTimer();
    void ShowTimer();
    void ExecuteUbergraph_BP_HudTimerComponent(int32 EntryPoint);
}; // Size: 0x108
