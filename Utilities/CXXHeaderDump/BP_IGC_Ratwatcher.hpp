#ifndef UE4SS_SDK_BP_IGC_Ratwatcher_HPP
#define UE4SS_SDK_BP_IGC_Ratwatcher_HPP

class ABP_IGC_Ratwatcher_C : public AActor
{
    ...
    class ABP_CFS1165_Rats_C* Rat;                                                    // 0x0338 (size: 0x8)
    ...
    void ExecuteUbergraph_BP_IGC_Ratwatcher(int32 EntryPoint);
}; // Size: 0x34C
