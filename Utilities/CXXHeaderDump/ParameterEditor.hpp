#ifndef UE4SS_SDK_ParameterEditor_HPP
#define UE4SS_SDK_ParameterEditor_HPP

class UParameterEditor_C : public UUserWidget
{
    ...
    void Construct();
    void ExecuteUbergraph_ParameterEditor(int32 EntryPoint);
}; // Size: 0x230
