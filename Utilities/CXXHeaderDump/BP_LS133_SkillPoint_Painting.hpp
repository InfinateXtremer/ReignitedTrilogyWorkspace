#ifndef UE4SS_SDK_BP_LS133_SkillPoint_Painting_HPP
#define UE4SS_SDK_BP_LS133_SkillPoint_Painting_HPP

class ABP_LS133_SkillPoint_Painting_C : public ABP_LevelActor_Base_C
{
    ...
    void ExecuteUbergraph_BP_LS133_SkillPoint_Painting(int32 EntryPoint);
}; // Size: 0x470
