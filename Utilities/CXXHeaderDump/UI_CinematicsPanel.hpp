#ifndef UE4SS_SDK_UI_CinematicsPanel_HPP
#define UE4SS_SDK_UI_CinematicsPanel_HPP

class UUI_CinematicsPanel_C : public UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0208 (size: 0x8)
    class UExpandableArea* AnimationsArea;                                            // 0x0210 (size: 0x8)
    class UScrollBox* CinematicsList;                                                 // 0x0218 (size: 0x8)
    class UUI_Cine_TextBlock_C* CineTextBlock;                                        // 0x0220 (size: 0x8)
    TArray<FAssetData> Cinematics;                                                    // 0x0228 (size: 0x10)
    ...
    void BndEvt__AnimationsArea_K2Node_ComponentBoundEvent_19_OnExpandableAreaExpansionChanged__DelegateSignature(class UExpandableArea* Area, bool bIsExpanded);
    void ExecuteUbergraph_UI_CinematicsPanel(int32 EntryPoint);
}; // Size: 0x238
