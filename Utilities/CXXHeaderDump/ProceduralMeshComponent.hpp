...
{
    bool bUseComplexAsSimpleCollision;                                                // 0x06A0 (size: 0x1)
    bool bUseAsyncCooking;                                                            // 0x06A1 (size: 0x1)
    class UBodySetup* ProcMeshBodySetup;                                              // 0x06A8 (size: 0x8)
    TArray<FProcMeshSection> ProcMeshSections;                                        // 0x06B0 (size: 0x10)
    TArray<FKConvexElem> CollisionConvexElems;                                        // 0x06C0 (size: 0x10)
    FBoxSphereBounds LocalBounds;                                                     // 0x06D0 (size: 0x1C)
    TArray<class UBodySetup*> AsyncBodySetupQueue;                                    // 0x06F0 (size: 0x10)
