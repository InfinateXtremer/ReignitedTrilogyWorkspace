...
class UActorSequence : public UMovieSceneSequence
{
    ...
    FActorSequenceObjectReferenceMap ObjectReferences;                                // 0x03B8 (size: 0x20)

}; // Size: 0x3E0

class UActorSequenceComponent : public UActorComponent
{
    FMovieSceneSequencePlaybackSettings PlaybackSettings;                             // 0x00F0 (size: 0x30)
    class UActorSequence* Sequence;                                                   // 0x0120 (size: 0x8)
    class UActorSequencePlayer* SequencePlayer;                                       // 0x0128 (size: 0x8)
    bool bAutoPlay;                                                                   // 0x0130 (size: 0x1)
