#ifndef UE4SS_SDK_BP_LS119_Torch_HPP
#define UE4SS_SDK_BP_LS119_Torch_HPP

class ABP_LS119_Torch_C : public AActor
{
    ...
    void ExecuteUbergraph_BP_LS119_Torch(int32 EntryPoint);
}; // Size: 0x348
