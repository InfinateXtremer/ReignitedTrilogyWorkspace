#ifndef UE4SS_SDK_UI_ParticlesPanel_HPP
#define UE4SS_SDK_UI_ParticlesPanel_HPP

class UUI_ParticlesPanel_C : public UUserWidget
{
    ...
    TArray<FString> Levels;                                                           // 0x0228 (size: 0x10)
    ...
    void ExecuteUbergraph_UI_ParticlesPanel(int32 EntryPoint);
}; // Size: 0x238
