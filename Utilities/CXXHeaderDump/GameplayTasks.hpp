...
{
    bool bIsNetDirty;                                                                 // 0x00F8 (size: 0x1)
    TArray<class UGameplayTask*> SimulatedTasks;                                      // 0x0100 (size: 0x10)
    TArray<class UGameplayTask*> TaskPriorityQueue;                                   // 0x0110 (size: 0x10)
    TArray<class UGameplayTask*> TickingTasks;                                        // 0x0130 (size: 0x10)
    TArray<class UGameplayTask*> KnownTasks;                                          // 0x0140 (size: 0x10)
    FGameplayTasksComponentOnClaimedResourcesChange OnClaimedResourcesChange;         // 0x0158 (size: 0x10)
