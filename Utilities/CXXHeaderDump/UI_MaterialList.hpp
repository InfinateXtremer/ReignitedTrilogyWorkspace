#ifndef UE4SS_SDK_UI_MaterialList_HPP
#define UE4SS_SDK_UI_MaterialList_HPP

class UUI_MaterialList_C : public UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0208 (size: 0x8)
    class UExpandableArea* ExpandableArea_0;                                          // 0x0210 (size: 0x8)
    class UScrollBox* MaterialList;                                                   // 0x0218 (size: 0x8)
    class UUI_Cine_TextBlock_C* UI_CineTextBlock;                                     // 0x0220 (size: 0x8)
    class AActor* Actor;                                                              // 0x0228 (size: 0x8)
    ...
    void HandleDynamicMaterialCreation(class UMaterialInterface* SourceMaterial, int32 ElementIndex, class UPrimitiveComponent* MeshComponent, class UMaterialInstanceDynamic*& AsMaterial Instance Dynamic);
    FText GetText_0();
    ...
    void BndEvt__ExpandableArea_0_K2Node_ComponentBoundEvent_4_OnExpandableAreaExpansionChanged__DelegateSignature(class UExpandableArea* Area, bool bIsExpanded);
    void IUpdateSelectedActor(class AActor* Actor);
    void Construct();
    void CustomEvent_0(class AActor* DestroyedActor);
    void ExecuteUbergraph_UI_MaterialList(int32 EntryPoint);
}; // Size: 0x230
