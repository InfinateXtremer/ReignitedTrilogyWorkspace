#ifndef UE4SS_SDK_UI_Camera_HPP
#define UE4SS_SDK_UI_Camera_HPP

class UUI_Camera_C : public UFalconWidget
{
    ...
    class UUI_General_Toggle_C* 002Camera;                                            // 0x0238 (size: 0x8)
    class UUI_General_Toggle_C* 003MotionBlur;                                        // 0x0240 (size: 0x8)
    class UUI_General_Toggle_C* 004InvertX;                                           // 0x0248 (size: 0x8)
    class UUI_General_Toggle_C* 005InvertY;                                           // 0x0250 (size: 0x8)
    class UUI_SoundBar_C* 006MouseSensitivitySlider;                                  // 0x0258 (size: 0x8)
    ...
    class USizeBox* UI_SizeBox;                                                       // 0x0278 (size: 0x8)
    ...
    FText footer label toggle;                                                        // 0x02B0 (size: 0x18)
    FText footer label back;                                                          // 0x02C8 (size: 0x18)
    float MouseMinSensitivity;                                                        // 0x02E0 (size: 0x4)
    float MouseMaxSensitivity;                                                        // 0x02E4 (size: 0x4)
    ...
    void Toggle Motion Blur(bool Default);
    ...
    void ExecuteUbergraph_UI_Camera(int32 EntryPoint);
}; // Size: 0x2E8
