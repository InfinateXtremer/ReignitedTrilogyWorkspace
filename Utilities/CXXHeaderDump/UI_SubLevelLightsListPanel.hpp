#ifndef UE4SS_SDK_UI_SubLevelLightsListPanel_HPP
#define UE4SS_SDK_UI_SubLevelLightsListPanel_HPP

class UUI_SubLevelLightsListPanel_C : public UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0208 (size: 0x8)
    class UScrollBox* LightList;                                                      // 0x0210 (size: 0x8)
    class UExpandableArea* LightsArea;                                                // 0x0218 (size: 0x8)
    ...
    void Construct();
    void ExecuteUbergraph_UI_SubLevelLightsListPanel(int32 EntryPoint);
}; // Size: 0x238
