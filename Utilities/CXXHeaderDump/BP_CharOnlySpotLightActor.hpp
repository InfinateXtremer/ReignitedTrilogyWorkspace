#ifndef UE4SS_SDK_BP_CharOnlySpotLightActor_HPP
#define UE4SS_SDK_BP_CharOnlySpotLightActor_HPP

class ABP_CharOnlySpotLightActor_C : public APawn
{
    ...
    void ExecuteUbergraph_BP_CharOnlySpotLightActor(int32 EntryPoint);
}; // Size: 0x3A0
