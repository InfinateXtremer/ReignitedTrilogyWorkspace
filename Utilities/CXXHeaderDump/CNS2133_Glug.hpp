#ifndef UE4SS_SDK_CNS2133_Glug_HPP
#define UE4SS_SDK_CNS2133_Glug_HPP

class ACNS2133_Glug_C : public ABP_Base_Friendly_C
{
    ...
    void ExecuteUbergraph_CNS2133_Glug(int32 EntryPoint);
}; // Size: 0x95C
