#ifndef UE4SS_SDK_UI_HUD_Plus_HPP
#define UE4SS_SDK_UI_HUD_Plus_HPP

class UUI_HUD_Plus_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_UI_HUD_Plus(int32 EntryPoint);
}; // Size: 0x260
