#ifndef UE4SS_SDK_BP_Scale_Gizmo_HPP
#define UE4SS_SDK_BP_Scale_Gizmo_HPP

class ABP_Scale_Gizmo_C : public ABP_Gizmo_Base_C
{
    ...
    FVector CurrentOffset;                                                            // 0x0374 (size: 0xC)
    bool WasSimulatingPhysics;                                                        // 0x0380 (size: 0x1)
    bool Clicking;                                                                    // 0x0381 (size: 0x1)
    ...
    void ExecuteUbergraph_BP_Scale_Gizmo(int32 EntryPoint);
}; // Size: 0x382
