...
{
    FSoftObjectPath EditorStartupMap;                                                 // 0x0028 (size: 0x18)
    FString LocalMapOptions;                                                          // 0x0040 (size: 0x10)
    FSoftObjectPath TransitionMap;                                                    // 0x0050 (size: 0x18)
    bool bUseSplitscreen;                                                             // 0x0068 (size: 0x1)
    TEnumAsByte<ETwoPlayerSplitScreenType::Type> TwoPlayerSplitscreenLayout;          // 0x0069 (size: 0x1)
    TEnumAsByte<EThreePlayerSplitScreenType::Type> ThreePlayerSplitscreenLayout;      // 0x006A (size: 0x1)
    bool bOffsetPlayerGamepadIds;                                                     // 0x006B (size: 0x1)
    FSoftClassPath GameInstanceClass;                                                 // 0x0070 (size: 0x18)
    FSoftObjectPath GameDefaultMap;                                                   // 0x0088 (size: 0x18)
    FSoftObjectPath ServerDefaultMap;                                                 // 0x00A0 (size: 0x18)
    FSoftClassPath GlobalDefaultGameMode;                                             // 0x00B8 (size: 0x18)
    FSoftClassPath GlobalDefaultServerGameMode;                                       // 0x00D0 (size: 0x18)
    TArray<FGameModeName> GameModeMapPrefixes;                                        // 0x00E8 (size: 0x10)
    TArray<FGameModeName> GameModeClassAliases;                                       // 0x00F8 (size: 0x10)
