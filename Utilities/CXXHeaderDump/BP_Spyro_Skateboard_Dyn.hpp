#ifndef UE4SS_SDK_BP_Spyro_Skateboard_Dyn_HPP
#define UE4SS_SDK_BP_Spyro_Skateboard_Dyn_HPP

class ABP_Spyro_Skateboard_Dyn_C : public AActor
{
    ...
    void ExecuteUbergraph_BP_Spyro_Skateboard_Dyn(int32 EntryPoint);
}; // Size: 0x340
