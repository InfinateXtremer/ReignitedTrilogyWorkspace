#ifndef UE4SS_SDK_UI_GameplayContainer_HPP
#define UE4SS_SDK_UI_GameplayContainer_HPP

class UUI_GameplayContainer_C : public UFalconLayerWidget
{
    ...
    void do fade in();
    void do fade out();
    void ExecuteUbergraph_UI_GameplayContainer(int32 EntryPoint);
}; // Size: 0x238
