#ifndef UE4SS_SDK_BP_CBS1002_Blowhard_Projectile_Stage2_HPP
#define UE4SS_SDK_BP_CBS1002_Blowhard_Projectile_Stage2_HPP

class ABP_CBS1002_Blowhard_Projectile_Stage2_C : public APhasmidBasicProjectile
{
    ...
    float Timeline_0_NewTrack_1_DBF7EEBA42E32A87F528DC8FC588678C;                     // 0x0658 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_0__Direction_DBF7EEBA42E32A87F528DC8FC588678C; // 0x065C (size: 0x1)
    ...
    void ExecuteUbergraph_BP_CBS1002_Blowhard_Projectile_Stage2(int32 EntryPoint);
}; // Size: 0x684
