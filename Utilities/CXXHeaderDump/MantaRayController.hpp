#ifndef UE4SS_SDK_MantaRayController_HPP
#define UE4SS_SDK_MantaRayController_HPP

class AMantaRayController_C : public AActor
{
    ...
    class AActor* HunterIGC;                                                          // 0x03C0 (size: 0x8)
    int32 Hunter_IGC_Index;                                                           // 0x03C8 (size: 0x4)
    ...
    void ExecuteUbergraph_MantaRayController(int32 EntryPoint);
}; // Size: 0x3CC
