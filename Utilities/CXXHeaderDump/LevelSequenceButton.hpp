#ifndef UE4SS_SDK_LevelSequenceButton_HPP
#define UE4SS_SDK_LevelSequenceButton_HPP

class ULevelSequenceButton_C : public UUserWidget
{
    ...
    class ULevelSequencePlayer* LevelSequence;                                        // 0x0278 (size: 0x8)
    class ALevelSequenceActor* LevelSequenceActor;                                    // 0x0280 (size: 0x8)
    ...
    void OnLoaded_59CF3A4E4D991C3739E81CA4BA0D8650(class UObject* Loaded);
    ...
    void Construct();
    void ExecuteUbergraph_LevelSequenceButton(int32 EntryPoint);
}; // Size: 0x288
