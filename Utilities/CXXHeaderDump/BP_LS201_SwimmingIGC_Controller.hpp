#ifndef UE4SS_SDK_BP_LS201_SwimmingIGC_Controller_HPP
#define UE4SS_SDK_BP_LS201_SwimmingIGC_Controller_HPP

class ABP_LS201_SwimmingIGC_Controller_C : public AActor
{
    ...
    void ExecuteUbergraph_BP_LS201_SwimmingIGC_Controller(int32 EntryPoint);
}; // Size: 0x348
