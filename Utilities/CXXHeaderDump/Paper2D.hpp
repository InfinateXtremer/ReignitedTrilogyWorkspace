...
{
    class UPaperFlipbookComponent* Sprite;                                            // 0x0720 (size: 0x8)

}; // Size: 0x730

class APaperFlipbookActor : public AActor
{
    class UPaperFlipbookComponent* RenderComponent;                                   // 0x0318 (size: 0x8)

}; // Size: 0x320

class APaperGroupedSpriteActor : public AActor
{
    class UPaperGroupedSpriteComponent* RenderComponent;                              // 0x0318 (size: 0x8)

}; // Size: 0x320

class APaperSpriteActor : public AActor
{
    class UPaperSpriteComponent* RenderComponent;                                     // 0x0318 (size: 0x8)

}; // Size: 0x320

class APaperTerrainActor : public AActor
{
    class USceneComponent* DummyRoot;                                                 // 0x0318 (size: 0x8)
    class UPaperTerrainSplineComponent* SplineComponent;                              // 0x0320 (size: 0x8)
    class UPaperTerrainComponent* RenderComponent;                                    // 0x0328 (size: 0x8)

}; // Size: 0x330

class APaperTileMapActor : public AActor
{
    class UPaperTileMapComponent* RenderComponent;                                    // 0x0318 (size: 0x8)

}; // Size: 0x320

class UMaterialExpressionSpriteTextureSampler : public UMaterialExpressionTextureSampleParameter2D
{
    bool bSampleAdditionalTextures;                                                   // 0x0198 (size: 0x1)
    int32 AdditionalSlotIndex;                                                        // 0x019C (size: 0x4)
    FText SlotDisplayName;                                                            // 0x01A0 (size: 0x18)
...
{
    class UPaperFlipbook* SourceFlipbook;                                             // 0x0698 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x06A0 (size: 0x8)
    float PlayRate;                                                                   // 0x06A8 (size: 0x4)
    uint8 bLooping;                                                                   // 0x06AC (size: 0x1)
    uint8 bReversePlayback;                                                           // 0x06AC (size: 0x1)
    uint8 bPlaying;                                                                   // 0x06AC (size: 0x1)
    float AccumulatedTime;                                                            // 0x06B0 (size: 0x4)
    int32 CachedFrameIndex;                                                           // 0x06B4 (size: 0x4)
    FLinearColor SpriteColor;                                                         // 0x06B8 (size: 0x10)
    class UBodySetup* CachedBodySetup;                                                // 0x06C8 (size: 0x8)
    FPaperFlipbookComponentOnFinishedPlaying OnFinishedPlaying;                       // 0x06D0 (size: 0x10)
...
{
    TArray<class UMaterialInterface*> InstanceMaterials;                              // 0x0698 (size: 0x10)
    TArray<FSpriteInstanceData> PerInstanceSpriteData;                                // 0x06A8 (size: 0x10)
...
{
    FVector2D SourceUV;                                                               // 0x0038 (size: 0x8)
    FVector2D SourceDimension;                                                        // 0x0040 (size: 0x8)
    class UTexture2D* SourceTexture;                                                  // 0x0048 (size: 0x8)
    TArray<class UTexture*> AdditionalSourceTextures;                                 // 0x0050 (size: 0x10)
    FVector2D BakedSourceUV;                                                          // 0x0060 (size: 0x8)
    FVector2D BakedSourceDimension;                                                   // 0x0068 (size: 0x8)
    class UTexture2D* BakedSourceTexture;                                             // 0x0070 (size: 0x8)
    class UMaterialInterface* DefaultMaterial;                                        // 0x0078 (size: 0x8)
    class UMaterialInterface* AlternateMaterial;                                      // 0x0080 (size: 0x8)
    TArray<FPaperSpriteSocket> Sockets;                                               // 0x0088 (size: 0x10)
    TEnumAsByte<ESpriteCollisionMode::Type> SpriteCollisionDomain;                    // 0x0098 (size: 0x1)
    float PixelsPerUnrealUnit;                                                        // 0x009C (size: 0x4)
    class UBodySetup* BodySetup;                                                      // 0x00A0 (size: 0x8)
    int32 AlternateMaterialSplitIndex;                                                // 0x00A8 (size: 0x4)
    TArray<FVector4> BakedRenderData;                                                 // 0x00B0 (size: 0x10)
...
{
    class UPaperSprite* SourceSprite;                                                 // 0x0698 (size: 0x8)
    class UMaterialInterface* MaterialOverride;                                       // 0x06A0 (size: 0x8)
    FLinearColor SpriteColor;                                                         // 0x06A8 (size: 0x10)
...
{
    class UPaperTerrainMaterial* TerrainMaterial;                                     // 0x0670 (size: 0x8)
    bool bClosedSpline;                                                               // 0x0678 (size: 0x1)
    bool bFilledSpline;                                                               // 0x0679 (size: 0x1)
    class UPaperTerrainSplineComponent* AssociatedSpline;                             // 0x0680 (size: 0x8)
    int32 RandomSeed;                                                                 // 0x0688 (size: 0x4)
    float SegmentOverlapAmount;                                                       // 0x068C (size: 0x4)
    FLinearColor TerrainColor;                                                        // 0x0690 (size: 0x10)
    int32 ReparamStepsPerSegment;                                                     // 0x06A0 (size: 0x4)
    TEnumAsByte<ESpriteCollisionMode::Type> SpriteCollisionDomain;                    // 0x06A4 (size: 0x1)
    float CollisionThickness;                                                         // 0x06A8 (size: 0x4)
    class UBodySetup* CachedBodySetup;                                                // 0x06B0 (size: 0x8)
...
{
    int32 MapWidth;                                                                   // 0x0698 (size: 0x4)
    int32 MapHeight;                                                                  // 0x069C (size: 0x4)
    int32 TileWidth;                                                                  // 0x06A0 (size: 0x4)
    int32 TileHeight;                                                                 // 0x06A4 (size: 0x4)
    class UPaperTileSet* DefaultLayerTileSet;                                         // 0x06A8 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x06B0 (size: 0x8)
    TArray<class UPaperTileLayer*> TileLayers;                                        // 0x06B8 (size: 0x10)
    FLinearColor TileMapColor;                                                        // 0x06C8 (size: 0x10)
    int32 UseSingleLayerIndex;                                                        // 0x06D8 (size: 0x4)
    bool bUseSingleLayer;                                                             // 0x06DC (size: 0x1)
    class UPaperTileMap* TileMap;                                                     // 0x06E0 (size: 0x8)
