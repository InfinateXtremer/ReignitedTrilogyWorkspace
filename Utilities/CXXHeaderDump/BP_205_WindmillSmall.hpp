#ifndef UE4SS_SDK_BP_205_WindmillSmall_HPP
#define UE4SS_SDK_BP_205_WindmillSmall_HPP

class ABP_205_WindmillSmall_C : public AMission_Item_Base_StateMachine_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0480 (size: 0x8)
    class UAkComponent* AkAudio;                                                      // 0x0488 (size: 0x8)
    class USphereComponent* Sphere;                                                   // 0x0490 (size: 0x8)
    class UBoxComponent* Box1;                                                        // 0x0498 (size: 0x8)
    class UStaticMeshComponent* Fan;                                                  // 0x04A0 (size: 0x8)
    class AActor* SpiritActor;                                                        // 0x04A8 (size: 0x8)
    FGameplayTagContainer NewVar_0;                                                   // 0x04B0 (size: 0x20)
    ...
    void ExecuteUbergraph_BP_205_WindmillSmall(int32 EntryPoint);
}; // Size: 0x4D0
