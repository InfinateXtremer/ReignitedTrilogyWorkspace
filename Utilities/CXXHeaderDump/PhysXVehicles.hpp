...
{
    FRuntimeFloatCurve TorqueCurve;                                                   // 0x0000 (size: 0x78)
    float MaxRPM;                                                                     // 0x0078 (size: 0x4)
    float MOI;                                                                        // 0x007C (size: 0x4)
    float DampingRateFullThrottle;                                                    // 0x0080 (size: 0x4)
    float DampingRateZeroThrottleClutchEngaged;                                       // 0x0084 (size: 0x4)
    float DampingRateZeroThrottleClutchDisengaged;                                    // 0x0088 (size: 0x4)
...
{
    class USkeletalMeshComponent* Mesh;                                               // 0x0378 (size: 0x8)
    class UWheeledVehicleMovementComponent* VehicleMovement;                          // 0x0380 (size: 0x8)
...
{
    class UWheeledVehicleMovementComponent* WheeledVehicleMovementComponent;          // 0x0910 (size: 0x8)
...
{
    uint8 bDeprecatedSpringOffsetMode;                                                // 0x0180 (size: 0x1)
    TArray<FWheelSetup> WheelSetups;                                                  // 0x0188 (size: 0x10)
    float Mass;                                                                       // 0x0198 (size: 0x4)
    float DragCoefficient;                                                            // 0x019C (size: 0x4)
    float ChassisWidth;                                                               // 0x01A0 (size: 0x4)
    float ChassisHeight;                                                              // 0x01A4 (size: 0x4)
    bool bReverseAsBrake;                                                             // 0x01A8 (size: 0x1)
    float DragArea;                                                                   // 0x01AC (size: 0x4)
    float EstimatedMaxEngineSpeed;                                                    // 0x01B0 (size: 0x4)
    float MaxEngineRPM;                                                               // 0x01B4 (size: 0x4)
    float DebugDragMagnitude;                                                         // 0x01B8 (size: 0x4)
    FVector InertiaTensorScale;                                                       // 0x01BC (size: 0xC)
    float MinNormalizedTireLoad;                                                      // 0x01C8 (size: 0x4)
    float MinNormalizedTireLoadFiltered;                                              // 0x01CC (size: 0x4)
    float MaxNormalizedTireLoad;                                                      // 0x01D0 (size: 0x4)
    float MaxNormalizedTireLoadFiltered;                                              // 0x01D4 (size: 0x4)
    float ThresholdLongitudinalSpeed;                                                 // 0x01D8 (size: 0x4)
    int32 LowForwardSpeedSubStepCount;                                                // 0x01DC (size: 0x4)
    int32 HighForwardSpeedSubStepCount;                                               // 0x01E0 (size: 0x4)
    TArray<class UVehicleWheel*> Wheels;                                              // 0x01E8 (size: 0x10)
    uint8 bUseRVOAvoidance;                                                           // 0x0210 (size: 0x1)
    float RVOAvoidanceRadius;                                                         // 0x0214 (size: 0x4)
    float RVOAvoidanceHeight;                                                         // 0x0218 (size: 0x4)
    float AvoidanceConsiderationRadius;                                               // 0x021C (size: 0x4)
    float RVOSteeringStep;                                                            // 0x0220 (size: 0x4)
    float RVOThrottleStep;                                                            // 0x0224 (size: 0x4)
    int32 AvoidanceUID;                                                               // 0x0228 (size: 0x4)
    FNavAvoidanceMask AvoidanceGroup;                                                 // 0x022C (size: 0x4)
    FNavAvoidanceMask GroupsToAvoid;                                                  // 0x0230 (size: 0x4)
    FNavAvoidanceMask GroupsToIgnore;                                                 // 0x0234 (size: 0x4)
    float AvoidanceWeight;                                                            // 0x0238 (size: 0x4)
    FVector PendingLaunchVelocity;                                                    // 0x023C (size: 0xC)
    FReplicatedVehicleState ReplicatedState;                                          // 0x0248 (size: 0x14)
    float RawSteeringInput;                                                           // 0x0260 (size: 0x4)
    float RawThrottleInput;                                                           // 0x0264 (size: 0x4)
    float RawBrakeInput;                                                              // 0x0268 (size: 0x4)
    uint8 bRawHandbrakeInput;                                                         // 0x026C (size: 0x1)
    uint8 bRawGearUpInput;                                                            // 0x026C (size: 0x1)
    uint8 bRawGearDownInput;                                                          // 0x026C (size: 0x1)
    float SteeringInput;                                                              // 0x0270 (size: 0x4)
    float ThrottleInput;                                                              // 0x0274 (size: 0x4)
    float BrakeInput;                                                                 // 0x0278 (size: 0x4)
    float HandbrakeInput;                                                             // 0x027C (size: 0x4)
    float IdleBrakeInput;                                                             // 0x0280 (size: 0x4)
    float StopThreshold;                                                              // 0x0284 (size: 0x4)
    float WrongDirectionThreshold;                                                    // 0x0288 (size: 0x4)
    FVehicleInputRate ThrottleInputRate;                                              // 0x028C (size: 0x8)
    FVehicleInputRate BrakeInputRate;                                                 // 0x0294 (size: 0x8)
    FVehicleInputRate HandbrakeInputRate;                                             // 0x029C (size: 0x8)
    FVehicleInputRate SteeringInputRate;                                              // 0x02A4 (size: 0x8)
    uint8 bWasAvoidanceUpdated;                                                       // 0x02AC (size: 0x1)
    class AController* OverrideController;                                            // 0x02D8 (size: 0x8)
...
{
    FVehicleEngineData EngineSetup;                                                   // 0x02E0 (size: 0x90)
    FVehicleDifferential4WData DifferentialSetup;                                     // 0x0370 (size: 0x1C)
    FVehicleTransmissionData TransmissionSetup;                                       // 0x0390 (size: 0x30)
    FRuntimeFloatCurve SteeringCurve;                                                 // 0x03C0 (size: 0x78)
    float AckermannAccuracy;                                                          // 0x0438 (size: 0x4)
