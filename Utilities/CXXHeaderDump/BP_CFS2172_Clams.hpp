#ifndef UE4SS_SDK_BP_CFS2172_Clams_HPP
#define UE4SS_SDK_BP_CFS2172_Clams_HPP

class ABP_CFS2172_Clams_C : public ABP_Base_Fodder_C
{
    ...
    void ExecuteUbergraph_BP_CFS2172_Clams(int32 EntryPoint);
}; // Size: 0xB18
