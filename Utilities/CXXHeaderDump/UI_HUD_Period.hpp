#ifndef UE4SS_SDK_UI_HUD_Period_HPP
#define UE4SS_SDK_UI_HUD_Period_HPP

class UUI_HUD_Period_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_UI_HUD_Period(int32 EntryPoint);
}; // Size: 0x260
