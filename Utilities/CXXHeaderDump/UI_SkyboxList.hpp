#ifndef UE4SS_SDK_UI_SkyboxList_HPP
#define UE4SS_SDK_UI_SkyboxList_HPP

class UUI_SkyboxList_C : public UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0208 (size: 0x8)
    class UUI_Cine_TextBlock_C* CineTextBlock;                                        // 0x0210 (size: 0x8)
    class UExpandableArea* SkyboxesArea;                                              // 0x0218 (size: 0x8)
    class UScrollBox* Skylist;                                                        // 0x0220 (size: 0x8)
    class AActor* UILightActor;                                                       // 0x0228 (size: 0x8)
    class AActor* UIActor;                                                            // 0x0230 (size: 0x8)
    class APawn* DrivableLightActor;                                                  // 0x0238 (size: 0x8)
    class UCineCameraComponent* Camera;                                               // 0x0240 (size: 0x8)
    class ABP_Falcon_Sky_Sphere_C* FalconSky;                                         // 0x0248 (size: 0x8)
    class ABP_CameraActor_C* CameraActor;                                             // 0x0250 (size: 0x8)
    class ACharacter* UICharacterActor;                                               // 0x0258 (size: 0x8)
    class UObject* CurrentPlayingAnimation;                                           // 0x0260 (size: 0x8)
    ...
    void BndEvt__Skyboxes_K2Node_ComponentBoundEvent_4029_OnExpandableAreaExpansionChanged__DelegateSignature(class UExpandableArea* Area, bool bIsExpanded);
    ...
    void ExecuteUbergraph_UI_SkyboxList(int32 EntryPoint);
}; // Size: 0x268
