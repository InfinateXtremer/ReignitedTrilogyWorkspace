#ifndef UE4SS_SDK_UI_HUD_Checkmark_HPP
#define UE4SS_SDK_UI_HUD_Checkmark_HPP

class UUI_HUD_Checkmark_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_UI_HUD_Checkmark(int32 EntryPoint);
}; // Size: 0x260
