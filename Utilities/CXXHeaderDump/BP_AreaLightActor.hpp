#ifndef UE4SS_SDK_BP_AreaLightActor_HPP
#define UE4SS_SDK_BP_AreaLightActor_HPP

class ABP_AreaLightActor_C : public APawn
{
    ...
    void ExecuteUbergraph_BP_AreaLightActor(int32 EntryPoint);
}; // Size: 0x3A0
