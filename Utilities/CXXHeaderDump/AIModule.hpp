...
struct FAIStimulus
{
    ...
    uint8 bSuccessfullySensed;                                                        // 0x0040 (size: 0x1)
...
{
    uint8 bStopAILogicOnUnposses;                                                     // 0x03B8 (size: 0x1)
    uint8 bLOSflag;                                                                   // 0x03B8 (size: 0x1)
    uint8 bSkipExtraLOSChecks;                                                        // 0x03B8 (size: 0x1)
    uint8 bAllowStrafe;                                                               // 0x03B8 (size: 0x1)
    uint8 bWantsPlayerState;                                                          // 0x03B8 (size: 0x1)
    uint8 bSetControlRotationFromPawnOrientation;                                     // 0x03B8 (size: 0x1)
    class UPathFollowingComponent* PathFollowingComponent;                            // 0x03C0 (size: 0x8)
    class UBrainComponent* BrainComponent;                                            // 0x03C8 (size: 0x8)
    class UAIPerceptionComponent* PerceptionComponent;                                // 0x03D0 (size: 0x8)
    class UPawnActionsComponent* ActionsComp;                                         // 0x03D8 (size: 0x8)
    class UBlackboardComponent* Blackboard;                                           // 0x03E0 (size: 0x8)
    class UGameplayTasksComponent* CachedGameplayTasksComponent;                      // 0x03E8 (size: 0x8)
    TSubclassOf<class UNavigationQueryFilter> DefaultNavigationFilterClass;           // 0x03F0 (size: 0x8)
    FAIControllerReceiveMoveCompleted ReceiveMoveCompleted;                           // 0x03F8 (size: 0x10)
...
{
    class UEnvQuery* QueryTemplate;                                                   // 0x0728 (size: 0x8)
    TArray<FEnvNamedValue> QueryParams;                                               // 0x0730 (size: 0x10)
    TArray<FAIDynamicParam> QueryConfig;                                              // 0x0740 (size: 0x10)
    float TimeLimitPerStep;                                                           // 0x0750 (size: 0x4)
    int32 StepToDebugDraw;                                                            // 0x0754 (size: 0x4)
    EEnvQueryHightlightMode HighlightMode;                                            // 0x0758 (size: 0x1)
    uint8 bDrawLabels;                                                                // 0x075C (size: 0x1)
    uint8 bDrawFailedItems;                                                           // 0x075C (size: 0x1)
    uint8 bReRunQueryOnlyOnFinishedMove;                                              // 0x075C (size: 0x1)
    uint8 bShouldBeVisibleInGame;                                                     // 0x075C (size: 0x1)
    uint8 bTickDuringGame;                                                            // 0x075C (size: 0x1)
    TEnumAsByte<EEnvQueryRunMode::Type> QueryingMode;                                 // 0x0760 (size: 0x1)
    FNavAgentProperties NavAgentProperties;                                           // 0x0768 (size: 0x20)
...
{
    TArray<class UAISenseConfig*> SensesConfig;                                       // 0x00F0 (size: 0x10)
    TSubclassOf<class UAISense> DominantSense;                                        // 0x0100 (size: 0x8)
    class AAIController* AIOwner;                                                     // 0x0118 (size: 0x8)
    FAIPerceptionComponentOnPerceptionUpdated OnPerceptionUpdated;                    // 0x01A0 (size: 0x10)
    FAIPerceptionComponentOnTargetPerceptionUpdated OnTargetPerceptionUpdated;        // 0x01B0 (size: 0x10)
...
{
    uint8 bAutoRegisterAsSource;                                                      // 0x00F0 (size: 0x1)
    TArray<class TSubclassOf<UAISense>> RegisterAsSourceForSenses;                    // 0x00F8 (size: 0x10)
...
{
    TArray<class UAISense*> Senses;                                                   // 0x0080 (size: 0x10)
    float PerceptionAgingRate;                                                        // 0x0090 (size: 0x4)
...
{
    TSubclassOf<class UUserDefinedStruct> ListenerDataType;                           // 0x0120 (size: 0x8)
    TArray<class UAIPerceptionComponent*> ListenerContainer;                          // 0x0128 (size: 0x10)
    TArray<class UAISenseEvent*> UnprocessedEvents;                                   // 0x0138 (size: 0x10)
...
{
    TArray<FAIDamageEvent> RegisteredEvents;                                          // 0x0120 (size: 0x10)
...
{
    TArray<FAINoiseEvent> NoiseEvents;                                                // 0x0120 (size: 0x10)
    float SpeedOfSoundSq;                                                             // 0x0130 (size: 0x4)
...
{
    TArray<FAIPredictionEvent> RegisteredEvents;                                      // 0x0120 (size: 0x10)
...
{
    int32 MaxTracesPerTick;                                                           // 0x01D0 (size: 0x4)
    int32 MinQueriesPerTimeSliceCheck;                                                // 0x01D4 (size: 0x4)
    double MaxTimeSlicePerTick;                                                       // 0x01D8 (size: 0x8)
    float HighImportanceQueryDistanceThreshold;                                       // 0x01E0 (size: 0x4)
    float MaxQueryImportance;                                                         // 0x01E8 (size: 0x4)
    float SightLimitQueryImportance;                                                  // 0x01EC (size: 0x4)

}; // Size: 0x200

class UAISense_Team : public UAISense
{
    TArray<FAITeamStimulusEvent> RegisteredEvents;                                    // 0x0120 (size: 0x10)

}; // Size: 0x130

class UAISense_Touch : public UAISense
{
    TArray<FAITouchEvent> RegisteredEvents;                                           // 0x0120 (size: 0x10)

}; // Size: 0x130

class UAISystem : public UAISystemBase
{
    FSoftClassPath PerceptionSystemClassName;                                         // 0x0050 (size: 0x18)
    FSoftClassPath HotSpotManagerClassName;                                           // 0x0068 (size: 0x18)
    float AcceptanceRadius;                                                           // 0x0080 (size: 0x4)
    float PathfollowingRegularPathPointAcceptanceRadius;                              // 0x0084 (size: 0x4)
    float PathfollowingNavLinkAcceptanceRadius;                                       // 0x0088 (size: 0x4)
    bool bFinishMoveOnGoalOverlap;                                                    // 0x008C (size: 0x1)
    bool bAcceptPartialPaths;                                                         // 0x008D (size: 0x1)
    bool bAllowStrafing;                                                              // 0x008E (size: 0x1)
    bool bEnableBTAITasks;                                                            // 0x008F (size: 0x1)
    bool bAllowControllersAsEQSQuerier;                                               // 0x0090 (size: 0x1)
    bool bEnableDebuggerPlugin;                                                       // 0x0091 (size: 0x1)
    TEnumAsByte<ECollisionChannel> DefaultSightCollisionChannel;                      // 0x0092 (size: 0x1)
    class UBehaviorTreeManager* BehaviorTreeManager;                                  // 0x0098 (size: 0x8)
    class UEnvQueryManager* EnvironmentQueryManager;                                  // 0x00A0 (size: 0x8)
    class UAIPerceptionSystem* PerceptionSystem;                                      // 0x00A8 (size: 0x8)
    TArray<class UAIAsyncTaskBlueprintProxy*> AllProxyObjects;                        // 0x00B0 (size: 0x10)
    class UAIHotSpotManager* HotSpotManager;                                          // 0x00C0 (size: 0x8)
    class UNavLocalGridManager* NavLocalGrids;                                        // 0x00C8 (size: 0x8)
...
class UAITask_MoveTo : public UAITask
{
    ...
    class UAITask_MoveTo* AIMoveTo(class AAIController* Controller, FVector GoalLocation, class AActor* GoalActor, float AcceptanceRadius, TEnumAsByte<EAIOptionFlag::Type> StopOnOverlap, TEnumAsByte<EAIOptionFlag::Type> AcceptPartialPath, bool bUsePathfinding, bool bLockAILogic, bool bUseContinuosGoalTracking);
}; // Size: 0x110
...
class UBTCompositeNode : public UBTNode
{
    ...
    uint8 bApplyDecoratorScope;                                                       // 0x00C0 (size: 0x1)
...
{
    TEnumAsByte<EBTParallelMode::Type> FinishMode;                                    // 0x00C8 (size: 0x1)
...
{
    TArray<class UBTNode*> NodeInstances;                                             // 0x0170 (size: 0x10)
...
{
    class UBrainComponent* BrainComp;                                                 // 0x00F0 (size: 0x8)
    class UBlackboardData* BlackboardAsset;                                           // 0x00F8 (size: 0x8)
    TArray<class UBlackboardKeyType*> KeyInstances;                                   // 0x0120 (size: 0x10)
...
{
    class UBlackboardComponent* BlackboardComp;                                       // 0x00F8 (size: 0x8)
    class AAIController* AIOwner;                                                     // 0x0100 (size: 0x8)
...
{
    FVector CrowdAgentMoveDirection;                                                  // 0x03B0 (size: 0xC)
    class UCharacterMovementComponent* CharacterMovement;                             // 0x03C0 (size: 0x8)
    FNavAvoidanceMask AvoidanceGroup;                                                 // 0x03C8 (size: 0x4)
    FNavAvoidanceMask GroupsToAvoid;                                                  // 0x03CC (size: 0x4)
    FNavAvoidanceMask GroupsToIgnore;                                                 // 0x03D0 (size: 0x4)
...
{
    TArray<FEnvQueryInstanceCache> InstanceCache;                                     // 0x00A0 (size: 0x10)
    TArray<class UEnvQueryContext*> LocalContexts;                                    // 0x00B0 (size: 0x10)
    TArray<class UEnvQueryInstanceBlueprintWrapper*> GCShieldedWrappers;              // 0x00C0 (size: 0x10)
    float MaxAllowedTestingTime;                                                      // 0x0124 (size: 0x4)
    bool bTestQueriesUsingBreadth;                                                    // 0x0128 (size: 0x1)
    int32 QueryCountWarningThreshold;                                                 // 0x012C (size: 0x4)
    double QueryCountWarningInterval;                                                 // 0x0130 (size: 0x8)
...
{
    class UNavLocalGridManager* GridManager;                                          // 0x03A8 (size: 0x8)
...
{
    class UNavMovementComponent* MovementComp;                                        // 0x0220 (size: 0x8)
    class ANavigationData* MyNavData;                                                 // 0x0230 (size: 0x8)
...
class UPawnAction : public UObject
{
    ...
    uint8 bAllowNewSameClassInstance;                                                 // 0x00B8 (size: 0x1)
    uint8 bReplaceActiveSameClassInstance;                                            // 0x00B8 (size: 0x1)
    uint8 bShouldPauseMovement;                                                       // 0x00B8 (size: 0x1)
    uint8 bAlwaysNotifyOnFinished;                                                    // 0x00B8 (size: 0x1)
...
class UPawnAction_Move : public UPawnAction
{
    ...
    FVector GoalLocation;                                                             // 0x00D8 (size: 0xC)
    float AcceptableRadius;                                                           // 0x00E4 (size: 0x4)
    TSubclassOf<class UNavigationQueryFilter> FilterClass;                            // 0x00E8 (size: 0x8)
    uint8 bAllowStrafe;                                                               // 0x00F0 (size: 0x1)
    uint8 bFinishOnOverlap;                                                           // 0x00F0 (size: 0x1)
    uint8 bUsePathfinding;                                                            // 0x00F0 (size: 0x1)
    uint8 bAllowPartialPath;                                                          // 0x00F0 (size: 0x1)
    uint8 bProjectGoalToNavigation;                                                   // 0x00F0 (size: 0x1)
    uint8 bUpdatePathToGoal;                                                          // 0x00F0 (size: 0x1)
    uint8 bAbortChildActionOnPathChange;                                              // 0x00F0 (size: 0x1)

}; // Size: 0x120

class UPawnAction_Repeat : public UPawnAction
{
    class UPawnAction* ActionToRepeat;                                                // 0x00D0 (size: 0x8)
    class UPawnAction* RecentActionCopy;                                              // 0x00D8 (size: 0x8)
    TEnumAsByte<EPawnActionFailHandling::Type> ChildFailureHandlingMode;              // 0x00E0 (size: 0x1)

}; // Size: 0xF0

class UPawnAction_Sequence : public UPawnAction
{
    TArray<class UPawnAction*> ActionSequence;                                        // 0x00D0 (size: 0x10)
    TEnumAsByte<EPawnActionFailHandling::Type> ChildFailureHandlingMode;              // 0x00E0 (size: 0x1)
    class UPawnAction* RecentActionCopy;                                              // 0x00E8 (size: 0x8)

}; // Size: 0x100

class UPawnAction_Wait : public UPawnAction
{
    float TimeToWait;                                                                 // 0x00D0 (size: 0x4)

}; // Size: 0xE0

class UPawnActionsComponent : public UActorComponent
{
    class APawn* ControlledPawn;                                                      // 0x00F0 (size: 0x8)
    TArray<FPawnActionStack> ActionStacks;                                            // 0x00F8 (size: 0x10)
    TArray<FPawnActionEvent> ActionEvents;                                            // 0x0108 (size: 0x10)
    class UPawnAction* CurrentAction;                                                 // 0x0118 (size: 0x8)
...
{
    float HearingThreshold;                                                           // 0x00F0 (size: 0x4)
    float LOSHearingThreshold;                                                        // 0x00F4 (size: 0x4)
    float SightRadius;                                                                // 0x00F8 (size: 0x4)
    float SensingInterval;                                                            // 0x00FC (size: 0x4)
    float HearingMaxSoundAge;                                                         // 0x0100 (size: 0x4)
    uint8 bEnableSensingUpdates;                                                      // 0x0104 (size: 0x1)
    uint8 bOnlySensePlayers;                                                          // 0x0104 (size: 0x1)
    uint8 bSeePawns;                                                                  // 0x0104 (size: 0x1)
    uint8 bHearNoises;                                                                // 0x0104 (size: 0x1)
    FPawnSensingComponentOnSeePawn OnSeePawn;                                         // 0x0110 (size: 0x10)
    FPawnSensingComponentOnHearNoise OnHearNoise;                                     // 0x0120 (size: 0x10)
    float PeripheralVisionAngle;                                                      // 0x0130 (size: 0x4)
    float PeripheralVisionCosine;                                                     // 0x0134 (size: 0x4)
